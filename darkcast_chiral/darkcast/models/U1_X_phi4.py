...
xfs = {
    ...
    "nue":     (lambda m, xH: -xP-1/2*xH, 0),
    "numu":    (lambda m, xH: -xP-1/2*xH, 0),
    "nutau":   (lambda m, xH: -xP-1/2*xH, 0),
    ...
    "Ne":      (lambda m, xH: 0, lambda m, xH: -4),
    "Nmu":     (lambda m, xH: 0, lambda m, xH: -4),
    "Ntau":    (lambda m, xH: 0, lambda m, xH: 5),
    }
