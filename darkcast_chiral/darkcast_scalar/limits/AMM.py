...
"""
This module provides the necessary calculations to set limits from
the lepton anomalous magnetic moments. Note that the SciPy package is
required to integrate loop functions. If run as a script, the relevant
'AMM' limits included in DarkCast will be created.
"""
